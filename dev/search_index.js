...
{
    "location": "#Splittings.@TripleJump",
    "page": "Introduction",
...
{
    "location": "#Splittings.jl-Documentation-1",
    "page": "Introduction",
...
{
    "location": "advections/#Splittings.advection!",
    "page": "Advection functions",
...
{
    "location": "examples/vlasov-ampere/#",
    "page": "Vlasov-Ampere",
    "title": "Vlasov-Ampere",
    "category": "page",
...
{
    "location": "examples/vlasov-ampere/#Vlasov-Ampere-1",
    "page": "Vlasov-Ampere",
    "title": "Vlasov-Ampere",
    "category": "section",
    "text": "notebookCompute Landau damping by solving Vlasov-Ampere system. fracft + υ fracfx - E(tx) fracfυ = 0fracEt = - J =  fυ dυ"
},

{
    "location": "examples/vlasov-ampere/#Algorithm-1",
    "page": "Vlasov-Ampere",
    "title": "Algorithm",
    "category": "section",
...
{
    "location": "examples/vlasov-poisson/#",
    "page": "Vlasov-Poisson",
...
{
    "location": "contributing/#How-to-Contribute-1",
    "page": "How to Contribute",
    "title": "How to Contribute",
    "category": "section",
...
{
    "location": "contributing/#Add-a-new-feature-1",
    "page": "How to Contribute",
    "title": "Add a new feature",
    "category": "section",
    "text": "Adding new functions to a Julia package is not easy because you must reload the package to test your code. The best way is to run julia in Splittings directory in pkg mode and activate the package:julia> pwd()\n\"/Users/navaro/.julia/dev/Splittings\"\n\n(v1.0) pkg> activate .\n\n(Splittings) pkg>Write your program in test directory and add an include line in the file runtests.jl. Just type test in the Julia console.(Splittings) pkg> test\n   Testing Splittings\n Resolving package versions...When it is finished you can move your functions in src directory and just keep the test."
},
